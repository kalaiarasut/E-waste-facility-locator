    ...
    <div id="slideshow" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="13.jpg" class="d-block w-50 mx-auto" alt="Mission">
            ...
            <div class="carousel-item">
                <img src="11.jpg" class="d-block w-50 mx-auto" alt="Vision">
                <div class="carousel-caption d-none d-md-block">
                    <h5>Our Vision</h5>
            ...
            <div class="carousel-item">
                <img src="12.jpg" class="d-block w-50 mx-auto" alt="Partnerships">
                <div class="carousel-caption d-none d-md-block">
                    <h5>Partnerships</h5>
...
<section class="mb-5">
    ...
    <div class="row">
        ...
        <div class="col-md-4 text-center">
            <img src="22.jpg" alt="Search Image" class="img-fluid mb-3" style="max-height: 150px;">
        ...
        <!-- Locate Section -->
        <div class="col-md-4 text-center">
            <img src="21.jpg" alt="Locate Image" class="img-fluid mb-3" style="max-height: 150px;">
        ...
        <!-- Recycle Section -->
        <div class="col-md-4 text-center">
            <img src="23.jpg" alt="Recycle Image" class="img-fluid mb-3" style="max-height: 150px;">
