...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $stmt = $conn->prepare("INSERT INTO pickupdetails (email, price, device, model, location, time, phone, date, facility, status, customer_id, images) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, 'pending', ?, ?)");
    ...
    $stmt->bind_param("sssssssssss", $email, $price, $device, $model, $location, $time, $phone, $date, $facility, $customerID, $images);
...
<div class="pickup-container">
    ...
    <form class="form-grid" id="pickupForm" method="POST" action="" enctype="multipart/form-data">
      ...
      <div class="form-section full-width">
        <label for="images">Upload Pictures (Optional):</label>
